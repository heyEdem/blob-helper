...
- [ ] Add a dependency-boundary test using Maven dependency output or classpath inspection.
- [ ] Assert no `org.springframework`, `jakarta.persistence`, `software.amazon.awssdk`, or `com.azure` artifacts are present.
- [ ] Run `./mvnw -pl blob-helper-core test`.

## Acceptance

- [ ] Boundary test fails if forbidden dependencies enter core.
