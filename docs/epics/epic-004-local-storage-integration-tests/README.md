...
- [ ] 4.1 [Add local storage module](tasks/task-001-add-local-storage-module.md)
- [ ] 4.2 [Implement local put get delete exists](tasks/task-002-implement-local-put-get-delete-exists.md)
