...
- [x] 5.3 [Add Azure storage module](tasks/task-003-add-azure-storage-module.md)
- [x] 5.4 [Implement Azure BlobStorage adapter](tasks/task-004-implement-azure-blob-storage-adapter.md)
- [x] 5.5 [Add provider SDK boundary and contract tests](tasks/task-005-add-provider-sdk-boundary-and-contract-tests.md)
