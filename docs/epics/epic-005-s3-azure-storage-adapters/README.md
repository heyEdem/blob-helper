...
- [ ] 5.1 [Add S3 storage module](tasks/task-001-add-s3-storage-module.md)
- [ ] 5.2 [Implement S3 BlobStorage adapter](tasks/task-002-implement-s3-blob-storage-adapter.md)
